...
//                handleSearchEZDeviceFileSuccess();
    ...
    public void onClick(View view) {
        if (view.getId()==R.id.remoteplayback_loading_play_btn) {
            startRemotePlayBack(getTimeBarSeekTime());
        }else if(view.getId()==R.id.remoteplayback_play_btn||
                view.getId()== R.id.remoteplayback_full_play_btn) {
        ...
        }else if(view.getId()==R.id.remoteplayback_replay_btn) {
            if (mStatus != STATUS_STOP) {
                stopRemotePlayBack();
            }
            startRemotePlayBack(null);
        }else if(view.getId()==R.id.remoteplayback_sound_btn||
                view.getId()== R.id.remoteplayback_full_sound_btn) {
            onSoundBtnClick();
        }else if(view.getId()==R.id.remoteplayback_previously_btn||
                view.getId()== R.id.remoteplayback_full_previously_btn||
                view.getId()== R.id.remoteplayback_small_previously_btn) {
            onCapturePicBtnClick();
        }else if(view.getId()==R.id.remoteplayback_capture_rl) {
            onCaptureRlClick();
        }else  if(view.getId()==R.id.remoteplayback_video_btn||
                view.getId()== R.id.remoteplayback_full_video_btn||
                view.getId()== R.id.remoteplayback_small_video_btn||
                view.getId()== R.id.remoteplayback_video_start_btn||
                view.getId()== R.id.remoteplayback_full_video_start_btn||
                view.getId()== R.id.remoteplayback_small_video_start_btn) {
            onRecordBtnClick();
        }else if(view.getId()==R.id.remoteplayback_full_down_btn){
