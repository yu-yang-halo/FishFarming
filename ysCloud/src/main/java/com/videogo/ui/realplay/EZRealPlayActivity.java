...
//        mRealPlaySv.setVisibility(View.VISIBLE);
    ...
    public void onClick(View view) {
        if (view.getId()== R.id.realplay_play_btn|| view.getId()== R.id.realplay_full_play_btn|| view.getId()== R.id.realplay_play_iv) {
            if (mStatus != RealPlayStatus.STATUS_STOP) {
                stopRealPlay();
                setRealPlayStopUI();
            } else {
        ...
        }else if(view.getId()==R.id.realplay_previously_btn|| view.getId()==R.id.realplay_previously_btn2|| view.getId()== R.id.realplay_full_previously_btn) {
            onCapturePicBtnClick();
        }else if(view.getId()== R.id.realplay_capture_rl) {
            onCaptureRlClick();
        }else  if(view.getId()==R.id.realplay_video_btn|| view.getId()== R.id.realplay_video_start_btn|| view.getId()== R.id.realplay_video_btn2||
        ...
        }else if(view.getId()== R.id.realplay_full_ptz_anim_btn) {
